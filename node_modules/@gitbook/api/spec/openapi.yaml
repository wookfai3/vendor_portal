...
tags:
  ...
  - name: analytics
    ...
    description: |
      Gather data-driven insights on how users interact with your spaces, pages, or entire site. Analytics can highlight trends and guide future content improvements.
  - name: translations
  ...
  - name: hive
    ...
    description: |
      Hive is a collaborative layer over your GitBook data, designed to streamline knowledge sharing, cross-project tasks, and reduce duplicate efforts among your teammates.
  - name: subdomains
...
paths:
  ...
  "/orgs/{organizationId}/sites/{siteId}/ai/response":
    post:
      ...
      description: |
        Experimental operation to generate an AI response in a site.
      tags:
        - sites
      x-internal: true
      security:
  ...
  "/orgs/{organizationId}/sites/{siteId}/ai/response/{responseId}":
    get:
      ...
      description: |
        Experimental operation to get an existing AI response in a site.
      tags:
        - sites
      x-internal: true
      security:
